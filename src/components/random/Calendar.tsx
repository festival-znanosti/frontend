        ...
        <div style={{ width: '165%' }} className="flex max-w-full flex-none flex-col sm:max-w-full">
          ...
          <div className="flex flex-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                <li className="relative mt-px flex lg:col-start-3" style={{ gridRow: '2 / span 12' }}>
                  <a
                    href="#"
                ...
                <li className="relative mt-px flex sm:col-start-3" style={{ gridRow: '98 / span 30' }}>
                  <a
                    href="#"
                  ...
                  >
                    ...
                    <p className="text-pink-500 group-hover:text-pink-700">
                      <time dateTime="2022-01-12T07:30">7:30 - 10:30</time>
                    </p>
                  </a>
                </li>
